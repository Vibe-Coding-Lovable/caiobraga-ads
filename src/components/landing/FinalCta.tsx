  ...
  return (
    <section className="relative overflow-hidden bg-surface-2/40 py-28 md:py-40">
      ...
      <div ref={ref} data-reveal-root className="relative mx-auto max-w-3xl px-6 text-center">
        <h2
          data-reveal
          className="font-display text-4xl leading-[1.1] text-ink sm:text-5xl md:text-6xl"
        >
          Seu escritório não precisa depender apenas do{" "}
          <em className="text-gold not-italic italic">acaso</em> para crescer.
        </h2>
